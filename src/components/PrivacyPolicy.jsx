  ...
  return (
    <>
      ...
      <div>
        ...
        <br />
        <p>• when you become part of F1’s fan database as a result of becoming a customer of an official Formula 1 site operated by a third party under licence (Please refer to Third Party Digital Products’ section below for more information); or</p>
        <br />
        <p>• otherwise provide your data to us directly or through third party channels, for example if you provide us your details so we can send you updates, offers and information about Formula 1.</p>
        <br />
        ...
        <br />
        <p>• Contact Data – which includes billing address, email address and telephone numbers.</p>
        <br />
        <p>• Communications Data – which includes your communication preferences and your preferences in receiving marketing from us and our third parties.</p>
        <br />
        <p>• Transaction Data – which includes details about payments to and from you and other details of products and services you have purchased from us or our third party partners.</p>
        <br />
        <p>• Financial Data – which includes bank account and payment card details.</p>
        <br />
        <p>• Technical Data – which includes technical information such as internet protocol (IP) address used to connect your computer to the internet, your login data, screen resolution details, browser type and version, time zone setting and location, mobile and network information, browser plug-in types and versions, operating system and platform, and other technology on the devices you use to access our Digital Products.</p>
        <br />
