    ...
    return (
        <>
            ...
            <div className="Slider1Component">
                <h1> Hit Netflix show Drive to Survive picks up prestigious Emmy Award</h1>
                <br></br>
                <p>
                ...
                <br></br>
                <p>“Obviously you’re not talking about a season where there’s a massive title rivalry, so really it’s interesting watching the fight for second, third, fourth taking place,” Executive Producer James Gay-Rees told Formula1.com at the time.
